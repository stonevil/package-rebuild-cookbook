...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "pkg/", "/pkg"
  ...
  config.vm.provision :chef_solo do |chef|
    ...
    chef.run_list = [
      ...
      "recipe[package-rebuild::environment]",
      "recipe[package-rebuild::prepare]",
      "recipe[package-rebuild::build]",
      "recipe[package-rebuild::upload]"
